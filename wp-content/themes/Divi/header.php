...
?>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-93475087-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-93475087-1');
	</script>
    ...
    })(window,document,'script','dataLayer','GTM-WSLJQWL');</script>
...
<body <?php body_class(); ?>>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WSLJQWL"
