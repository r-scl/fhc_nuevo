	...
	public function get_advanced_settings_fields(){
		...
		return array(
			...
			'wrap_custom_sections_with_div' => array(
				'name'=>'wrap_custom_sections_with_div', 'label'=>'Wrap custom sections with div.', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>1
			),
		);
	}
	...
	*******************************************/
	...
	public function render_form_element_tooltip1($msg){
        ...
        <td style="width: 16px; padding:0px;">
			<a href="javascript:void(0)" title="<?php echo $msg; ?>" class="thwcfe_tooltip"><img src="<?php echo THWCFE_ASSETS_URL; ?>/css/help.png" title=""/></a>
        </td>
        <?php
	}
